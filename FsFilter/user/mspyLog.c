...
// void GetProcessNameByID(ULONG ProcessID)
// {
...
//     }
//     else{
//         dwRet = GetProcessImageFileName(hProcess, szFile, MAX_PATH);
//         //dwRet = QueryFullProcessImageName(hProcess, 0, szFile, &dwSize);   //can get renamed process name when running.
//         if(dwRet){
...
#if defined(_WIN64)
        fprintf( File, "Opr\t  SeqNum  \t PreOp Time \t          Major Operation          \t          Minor Operation          \tTransactn \tName\n");
        fprintf( File, "---\t----------\t------------\t-----------------------------------\t-----------------------------------\t----------\t--------------------------------------------------\n");
#else
        fprintf( File, "Opr\t  SeqNum  \t PreOp Time \t          Major Operation          \t          Minor Operation          \tTransactn \tName\n");
        fprintf( File, "---\t----------\t------------\t-----------------------------------\t-----------------------------------\t----------\t--------------------------------------------------\n");
...
// #endif
...
#if defined(_WIN64)
        printf("Opr\t  SeqNum  \t PreOp Time \t          Major Operation          \t          Minor Operation          \tTransactn \tName\n");
        printf("---\t----------\t------------\t-----------------------------------\t-----------------------------------\t----------\t--------------------------------------------------\n");
#else
        printf("Opr\t  SeqNum  \t PreOp Time \t          Major Operation          \t          Minor Operation          \tTransactn \tName\n");
        printf("---\t----------\t------------\t-----------------------------------\t-----------------------------------\t----------\t--------------------------------------------------\n");
    ...
    //GetProcessNameByID(RecordData->ProcessId);

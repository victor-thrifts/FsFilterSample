...
#ifdef ALLOC_PRAGMA
#pragma alloc_text(INIT, SwapDriverEntry)
#pragma alloc_text(INIT, SwapReadDriverParameters)
#pragma alloc_text(PAGE, SwapFilterUnload)
#pragma alloc_text(PAGE, SwapCleanupVolumeContext)
#pragma alloc_text(PAGE, SwapInstanceQueryTeardown)
#pragma alloc_text(PAGE, SwapInstanceSetup)
#endif
...
NPAGED_LOOKASIDE_LIST SwapPre2PostContextList;
...
CONST FLT_OPERATION_REGISTRATION SwapCallbacks[] = {
	{ IRP_MJ_READ,
	0,
	SwapPreReadBuffers,
	SwapPostReadBuffers },
...
CONST FLT_CONTEXT_REGISTRATION SwapContextNotifications[] = {
...
CONST FLT_REGISTRATION SwapFilterRegistration = {

	sizeof(FLT_REGISTRATION),         //  Size
	FLT_REGISTRATION_VERSION,           //  Version
	0,                                  //  Flags

	SwapContextNotifications,               //  Context
	SwapCallbacks,                          //  Operation callbacks

	SwapFilterUnload,                       //  MiniFilterUnload

	SwapInstanceSetup,                      //  InstanceSetup
	SwapInstanceQueryTeardown,              //  InstanceQueryTeardown
...
--*/
{
	...
	ExInitializeNPagedLookasideList(&SwapPre2PostContextList,
		NULL,
		NULL,
		0,
...
//SwapDriverEntryExit:
	...
	if (!NT_SUCCESS(status)) {
		...
		ExDeleteNPagedLookasideList(&SwapPre2PostContextList);
	}
...
--*/
{
	...
	try {
		...
		p2pCtx = ExAllocateFromNPagedLookasideList(&SwapPre2PostContextList);
...
--*/
{
	...
	try {
		...
		if (cleanupAllocatedBuffer) {
			...
			ExFreeToNPagedLookasideList(&SwapPre2PostContextList,
				p2pCtx);
		}
	}
